...
<p class="PDq2pG_selectionAnchorContainer" data-start="197" data-end="318"><span style="font-size: 14pt;">Given an array <strong data-start="220" data-end="229">arr[]</strong> consisting of stones, where arr[i] represents the height of the i-th stone. </span></p>
<ul>
...
<span style="font-size: 18px;"><strong><span style="font-size: 18px;">Explanation:</span> </strong></span><span style="font-size: 18px;">The array is already in pyramid form.</span></pre>
